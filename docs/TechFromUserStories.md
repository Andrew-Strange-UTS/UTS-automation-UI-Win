...
- `server/runners/launch-in-session.ps1`, `server/utils/sessionLauncher.js`, `server/utils/sessionLauncher.test.js`, `server/scheduler-service.js`, `server/scheduler-service-paths.js`, `server/utils/schedulerService.js`, `server/routes/health.js`, `renderer/src/components/StartupChecks.jsx`
