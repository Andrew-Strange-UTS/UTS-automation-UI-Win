    ...
    >
      {serviceDown && (
        <div style={{
          ...
          <div>
            <strong style={{ color: "#dc2626" }}>Scheduler service is not running</strong>
            <div style={{ fontSize: "13px", color: "#666", marginTop: "2px" }}>
              Schedules will not execute until the service is started. Run <code style={{ background: "#eee", padding: "2px 5px", borderRadius: "3px" }}>node server/scheduler-service.js</code> or install it as a system service.
            </div>
          </div>
        </div>
      )}
